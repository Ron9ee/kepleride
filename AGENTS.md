...
- `src/` contains the core TypeScript codebase; Kepler-specific features live under `src/vs/workbench/contrib/Kepler/`.
...
- `npm run buildreact`: builds the React UI in `src/vs/workbench/contrib/Kepler/browser/react/`.
