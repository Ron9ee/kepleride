...
echo "Name=Kepler" >> VoidApp.AppDir/void.desktop && \
...
echo "StartupWMClass=Kepler" >> VoidApp.AppDir/void.desktop && \
...
echo "Keywords=Kepler;void;" >> VoidApp.AppDir/void.desktop && \
...
echo "Name=Kepler - URL Handler" > VoidApp.AppDir/void-url-handler.desktop && \
