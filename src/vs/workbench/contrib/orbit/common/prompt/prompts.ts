...
ext-$id.txt files are for terminals running outside of the Kepler IDE (e.g. iTerm, Terminal.app), $id.txt files are for terminals inside the Kepler IDE.
