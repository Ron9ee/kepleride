...
Kepler separately records basic usage like the number of messages people are sending. If you'd like to disable Kepler metrics, you may do so in Kepler's Settings.
`;
