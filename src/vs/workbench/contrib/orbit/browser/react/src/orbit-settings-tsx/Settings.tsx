		...
		>
			...
			>
				...
				<div className="text-sm text-void-fg-3 mb-4">
					{type === 'default' ? `${modelName} comes packaged with Kepler, so you shouldn't need to change these settings.`
						: isUnrecognizedModel
							? `Model not recognized by Kepler.`
							: `Kepler recognizes ${modelName} ("${recognizedModelName}").`}
				</div>
...
export const OllamaSetupInstructions = ({ sayWeAutoDetect }: { sayWeAutoDetect?: boolean }) => {
	return <div className='prose-p:my-0 prose-ol:list-decimal prose-p:py-0 prose-ol:my-0 prose-ol:py-0 prose-span:my-0 prose-span:py-0 text-void-fg-3 text-sm list-decimal select-text'>
		...
		{sayWeAutoDetect && <div className=' pl-6'><ChatMarkdownRender string={`Kepler automatically detects locally running models and enables them.`} chatMessageLocation={undefined} /></div>}
	</div>
}
			...
			<div className="flex flex-col md:flex-row w-full gap-6 max-w-[900px] mx-auto mb-32" style={{ minHeight: '80vh' }}>
				...
				<main className="flex-1 p-6 select-none">
					...
					<div className='max-w-3xl'>
						...
						<h1 className='text-2xl w-full'>{`Kepler's Settings`}</h1>
						...
						<div className='flex flex-col gap-12'>
							...
							<div className={shouldShowTab('localProviders') ? `` : 'hidden'}>
								<ErrorBoundary>
									...
									<h3 className={`text-void-fg-3 mb-2`}>{`Kepler can access any model that you host locally. We automatically detect your local models by default.`}</h3>
							...
							<div className={shouldShowTab('providers') ? `` : 'hidden'}>
								<ErrorBoundary>
									...
									<h3 className={`text-void-fg-3 mb-2`}>{`Kepler can access models from Anthropic, OpenAI, OpenRouter, and more.`}</h3>
										...
										<ErrorBoundary>
											<SettingsSection title="Editor">
												<SettingsCell
													...
													description="Display Kepler suggestions in the code editor when text is selected"
												>
													<VoidSwitch
														size='xs'
							...
							<div className={`${shouldShowTab('general') ? `` : 'hidden'} flex flex-col gap-12`}>
								...
								<div>
									<ErrorBoundary>
										...
										<h4 className='text-void-fg-3 mb-4'>{`Transfer your editor settings into Kepler.`}</h4>
								...
								<div>
									...
									<h4 className='text-void-fg-3 mb-4'>{`Transfer Kepler's settings and chats in and out of Kepler.`}</h4>
								...
								<div className='max-w-[600px]'>
									...
									<h4 className={`text-void-fg-3 mb-4`}>Very basic anonymous usage tracking helps us keep Kepler running smoothly. You may opt out below. Regardless of this setting, Kepler never sees your code, messages, or API keys.</h4>
...
Alternatively, place a \`.Keplerrules\` file in the root of your workspace.
							`} chatMessageLocation={undefined} />
									...
									<div className='my-4'>
										...
										<div className='text-void-fg-3 text-xs mt-1'>
											{`When disabled, Kepler will not include anything in the system message except for content you specified above.`}
										</div>
									</div>
								</div>
