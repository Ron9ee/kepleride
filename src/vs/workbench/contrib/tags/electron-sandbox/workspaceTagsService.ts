...
export class WorkspaceTagsService implements IWorkspaceTagsService {
	...
	/* __GDPR__FRAGMENT__
		"WorkspaceTags" : {
			...
			"workspace.go.mod.github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/Kepleral/armKepleral" : { "classification": "SystemMetaData", "purpose": "FeatureInsight", "isMeasurement": true },
