...
class VoidSettingsInput extends EditorInput {
	...
	override getName(): string {
		return nls.localize('keplerSettingsInputsName', 'Kepler\'s Settings');
	}
...
Registry.as<IEditorPaneRegistry>(EditorExtensions.EditorPane).registerEditorPane(
	EditorPaneDescriptor.create(VoidSettingsPane, VoidSettingsPane.ID, nls.localize('VoidSettingsPane', "Kepler\'s Settings Pane")),
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('keplerSettings', "Kepler: Toggle Settings"),
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: nls.localize2('keplerSettingsAction2', "Kepler: Open Settings"),
			f1: true,
			icon: Codicon.settingsGear,
		});
	}
...
MenuRegistry.appendMenuItem(MenuId.GlobalActivity, {
	...
	command: {
		id: VOID_TOGGLE_SETTINGS_ACTION_ID,
		title: nls.localize('keplerSettingsActionGear', "Kepler\'s Settings")
	},
	order: 1
});
