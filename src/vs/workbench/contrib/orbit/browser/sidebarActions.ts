...
registerAction2(class extends Action2 {
	constructor() {
		super({ id: VOID_OPEN_SIDEBAR_ACTION_ID, title: localize2('keplerOpenSidebar', 'Kepler: Open Sidebar'), f1: true });
	}
...
registerAction2(class extends Action2 {
	constructor() {
		super({ id: VOID_ADD_BROWSER_ELEMENT_SELECTION_ACTION_ID, title: 'Kepler: Add Browser Element Selection', f1: false });
	}
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			f1: true,
			title: localize2('keplerCmdL', 'Kepler: Add Selection to Chat'),
			keybinding: {
