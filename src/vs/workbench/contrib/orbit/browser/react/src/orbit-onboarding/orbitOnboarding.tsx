...
const VoidIcon = () => {
	...
	return <div ref={divRef} className='@@Kepler-Kepler-icon' />
}
		...
		<div className="h-[80vh] flex flex-col w-full max-w-[800px] mx-auto overflow-hidden">
			...
			<div className="text-center mb-8">
				<FadeIn>
					...
					<p className="text-void-fg-3 text-base">Assign the best models for each Kepler feature</p>
				</FadeIn>
			</div>
...
const VoidOnboardingContent = () => {
	...
	const lastPagePrevAndNextButtons = <div className="max-w-[600px] w-full mx-auto flex flex-col items-end">
		<div className="flex items-center gap-2">
			...
			>Enter the Kepler</PrimaryActionButton>
		</div>
	</div>
	...
	const detailedDescOfWantToUseOption: { [wantToUseOption in WantToUseOption]: string } = {
		...
		private: "Private-hosted so your data never leaves your computer or network. [Email us](mailto:founders@Keplereditor.com) for help setting up at your company.",
		...
		0: <OnboardingPageShell
			content={
				<div className='flex flex-col items-center gap-8'>
					<div className="text-5xl font-light text-center">Welcome to Kepler</div>

					{/* Slice of Kepler image */}
