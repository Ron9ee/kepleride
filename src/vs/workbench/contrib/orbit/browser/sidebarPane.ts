...
// const voidViewIcon = registerIcon('void-view-icon', voidThemeIcon, localize('keplerViewIcon', 'View icon of the Void chat view.'));
...
const container = viewContainerRegistry.registerViewContainer({
	...
	title: nls.localize2('keplerContainer', 'Chat'), // this is used to say "Void" (Ctrl + L)
...
viewsRegistry.registerViews([{
	...
	name: nls.localize2('keplerChat', ''), // this says ... : CHAT
...
export class SidebarStartContribution implements IWorkbenchContribution {
	...
	constructor(
		...
		this.commandService.executeCommand(VOID_OPEN_SIDEBAR_ACTION_ID).catch(error => {
			...
			console.error('Failed to open Kepler sidebar on startup:', error);
		});
	}
}
